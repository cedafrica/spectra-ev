        ...
        <section className="sm:px-32 px-10 sm:pb-[18.1rem] pb-20">
            <MaxContainer>
                        ...
                        partners.map((partner, index) => (
                            ...
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    className="text-[2rem] font-semibold">{partner.name}</h3>
                                    <p
                                    data-animation='paragraph' 
                                    className="text-[2rem] font-regular">{partner.text}</p>
                                </div>
                            </div>
                        ))
                    }
                ...
                <div className="flex flex-col mt-[8.4rem]">
                    <h2
                    data-animation='header' 
                    className="sm:text-[3.8rem] text-[2.8rem] font-bold text-center">Trusted by Industry Leaders</h2>
                    <p
                    data-animation='paragraph' 
                    className="text-[1.8rem] max-w-[300px] mx-auto text-center font-normal">We partner with the world's most respected audiovisual brands</p>
                </div>
