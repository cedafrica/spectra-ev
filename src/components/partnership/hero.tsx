const Hero = () => {
    return ( 
        <section className="flex bg-[url('/partner-hero.png')] bg-cover bg-no-repeat px-10 sm:px-32 flex-col justify-center bg-fixed text-white sm:h-[min(100vh,960px)] h-screen">
