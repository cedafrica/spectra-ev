    ...
    return (
        <section className={`relative flex ${backgroundImage} bg-cover bg-no-repeat px-10 sm:px-32 flex-col sm:bg-fixed justify-center text-white sm:h-[min(100vh,960px)] h-screen`}>
            ...
            <div className="relative z-10">
                ...
                className="sm:text-[4.1rem] max-w-300 text-[3.2rem] font-bold">{headlineText}</h1>
                <p 
                data-animation='paragraph'
                className="sm:text-[2rem] text-[1.6rem] max-w-200 w-full font-normal">{subHeadlineText}</p>
                <img
                    src="/cedia.png"
                    alt="cedia"
