...
const OurProcess = () => {
    ...
    return (
        <section className="bg-black  text-white sm:px-32 px-10 py-[5.4rem] sm:py-[8.2rem]">
            ...
            className="text-center text-[2.6rem] sm:text-[3.8rem]  font-bold">Our Process</h2>
            <p
            data-animation='paragraph' 
            className="text-center sm:text-[1.8rem] text-[1.6rem] font-normal max-w-[50.1rem] mx-auto">From initial consultation to ongoing support, we're with you every step of the way</p>
