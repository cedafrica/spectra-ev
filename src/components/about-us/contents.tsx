                ...
                <MaxContainer className="grid sm:grid-cols-2">
                    {
                        contents.map((content) => (
                            ...
                            >
                                ...
                                className="sm:text-[3rem] text-[2rem] font-bold">{content.header}</h2>
                                <p
                                data-animation='paragraph' 
                                className="sm:text-[2rem] text-[1.6rem]">{content.paragraph}</p>
                            </div>
                        ))
                    }
                </MaxContainer>
