    ...
    return (
        <section className="sm:px-32 px-9 pt-[2.9rem] sm:pt-[8.6rem] bg-white">
            <MaxContainer>
                ...
                <div className="grid sm:grid-cols-3 gap-[2.4rem] sm:gap-0 mt-10 sm:mt-[6.2rem]">
                    {
                        partners.map((partner, index) => (
                            ...
                            >
                                <img
                                    src={partner.image}
                                    alt={partner.name}
                                    className="sm:size-28 size-14 h-auto"
                                />
                                <div className="text-left">
                                    <h3 className="sm:text-[2rem] text-[1.8rem] font-semibold">{partner.name}</h3>
                                    <p className="sm:text-[2rem] text-[1.6rem] font-regular">{partner.text}</p>
                                </div>
                            </div>
                        ))
                    }
                ...
                <div className="flex flex-col-reverse mt-15 sm:mt-[18.3rem] sm:flex-row sm:gap-[4.8rem]  items-center">
                    <img
                        src="/arch.png"
                        alt=""
                        className="w-full mt-12 sm:mt-0 max-w-[58.8rem]"
                    />
                    <div className="flex flex-col">
                        <h2 className="sm:text-[4.6rem] text-[2.4rem] text-center sm:text-start font-semibold max-w-[50.4rem]">Elevating Audiovisual Excellence</h2>
