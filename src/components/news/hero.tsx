const Hero = () => {
    return ( 
        <section className="flex bg-[url('/news-hero.png')] bg-cover bg-no-repeat px-10 sm:px-32 flex-col items-center text-center justify-center text-white sm:h-[min(100vh,960px)] h-[28.4rem]">
