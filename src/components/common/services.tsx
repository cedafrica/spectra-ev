                        ...
                        return (
                            ...
                            >
                                <div 
                                    ...
                                    className="sm:text-[6.2rem] mt-[2.1rem] sm:mt-0 text-[2.4rem] font-semibold sm:font-bold sm:leading-[120%]">{solution.name}</h2>
                                    <p
                                     data-animation='paragraph'
                                    className="sm:text-[1.8rem] text-[1.6rem] mt-2 sm:mt-[2.8rem]">{solution.text}</p>
