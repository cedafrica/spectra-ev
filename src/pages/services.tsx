    ...
    return (
        <>
            ...
            <div className="px-10 pt-20 pb-20 sm:pb-0">
                ...
                className="text-center text-[2.2rem] sm:text-[3.6rem] font-bold">Where Every Space Speaks Through Sound, Light &
                    Vision.</h2>
                <p
                data-animation='paragraph' 
                className="text-center mt-2 sm:mb-30 text-[1.4rem] sm:text-[1.8rem] max-w-300 mx-auto">Bespoke AV integration that transforms commercial
